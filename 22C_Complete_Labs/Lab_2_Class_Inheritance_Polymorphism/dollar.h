...
/*
    ...
    Return: None
*/
 void Dollar::isEqual(const Currency& other) {
 ...
 /*
     ...
     Return: None
 */
void Dollar::isGreater(const Currency& other) {
    ...
    else std::cout << "Dollar stored in the array is greater than the compared dollar.." << std::endl;
};
/*
