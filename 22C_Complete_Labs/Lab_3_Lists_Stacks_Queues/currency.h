...
/*
 ...
 Changed void isEqual and void isGreater to bool isEqual and bool isGreater and got rid of their print messages 
*/
#ifndef CURRENCY_H
#define CURRENCY_H
...
public:
    ...
    // Virtual isEqual
    virtual bool isEqual(const Currency& other) = 0; // Changed to Boolean
    // Virtual isGreater
    virtual bool isGreater(const Currency& other) = 0; // Changed to Boolean
    // Getters
